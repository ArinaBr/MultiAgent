...
class Axis: 
    ...
    def draw(self, screen, tasks): 
        ...
        for i in range(1, self.lx//dx - 1): 
            pygame.draw.line(screen, (0, 0, 0), [self.x+i*dx, self.y-3], [self.x+i*dx, self.y + 3], 1) 
            shift=0 
...
def main(): 
    ...
    fps = 20 
    tasks=[13, 30, 20, 70, 45, 57] 
    axes=[ Axis(2, 100,200,300,70), Axis(1, 100,270,300,70), Axis(0, 100,340,300,70) ] 
    axes[0].taskIds=[0,1] 
    axes[1].taskIds=[2,3] 
    axes[2].taskIds=[4,5] 
    t=calcTime(tasks, axes) 
